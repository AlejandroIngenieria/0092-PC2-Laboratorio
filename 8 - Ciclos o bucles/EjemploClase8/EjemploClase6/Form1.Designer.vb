...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        btnAdminAgregar = New Button()
        btnAdminActualizar = New Button()
        ...
        ' TabPage2
        ' 
        TabPage2.Controls.Add(btnAdminActualizar)
        TabPage2.Controls.Add(btnAdminAgregar)
        ...
        gridAnimales.Size = New Size(1284, 427)
        gridAnimales.TabIndex = 0
        ' 
        ' btnAdminAgregar
        ' 
        btnAdminAgregar.Location = New Point(354, 594)
        btnAdminAgregar.Name = "btnAdminAgregar"
        btnAdminAgregar.Size = New Size(287, 73)
        btnAdminAgregar.TabIndex = 2
        btnAdminAgregar.Text = "Agregar"
        btnAdminAgregar.UseVisualStyleBackColor = True
        ' 
        ' btnAdminActualizar
        ' 
        btnAdminActualizar.Location = New Point(688, 594)
        btnAdminActualizar.Name = "btnAdminActualizar"
        btnAdminActualizar.Size = New Size(287, 73)
        btnAdminActualizar.TabIndex = 3
        btnAdminActualizar.Text = "Actualizar"
        btnAdminActualizar.UseVisualStyleBackColor = True
        ' 
        ' Form1
        ' 
    ...
    Friend WithEvents btnAdminActualizar As Button
    Friend WithEvents btnAdminAgregar As Button
